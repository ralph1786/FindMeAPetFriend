...
function fetchAnimals(e) {
  ...
  if (!(0, _validate.isValidZip)(zip)) {
    (0, _validate.showAlert)("Please Enter a Valid Zipcode");
  }
  //Fetch Pets
  (0, _fetchJsonp2.default)("http://api.petfinder.com/pet.find?format=json&key=d4507af808a734b446dd5ac5dc43321b&animal=" + animal + "&location=" + zip + "&callback=callback", {
...
//# sourceMappingURL=/main.c97f1e12.map